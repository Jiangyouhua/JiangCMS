...
class Plug_Captcha_Captcha {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontfile = DIR."/plug/captcha/".$this->resourcesPath.'/fonts/'.$fontcfg['font'];
    ...
    protected function WriteImage() {
        if ($this->imageFormat == 'png' && function_exists('imagepng')) {
            $this->filename="../plug/captcha/example.png";
            imagepng($this->im,$this->filename);
        } else {
            $this->filename="../plug/captcha/example.jpg";
            imagejpeg($this->im, $this->filename, 80);
        }
    }
